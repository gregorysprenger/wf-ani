//
// This file holds several functions specific to the main.nf workflow in the wf-ani pipeline
//
...
class WorkflowMain {
    ...
    public static String citation(workflow) {
        return "If you use ${workflow.manifest.name} for your analysis please cite:\n\n" +
            ...
            "  https://github.com/gregorysprenger/wf-ani/blob/main/CITATIONS.md"
    }
